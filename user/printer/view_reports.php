...
$query = "SHOW COLUMNS FROM printerreports";
...
$query = "SELECT * FROM printerreports";
...
<div class="container mt-5">
    <h1 class="text-center">Printer Reports</h1>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <?php endforeach; ?>
                            <td>
                                <a href='viewreport_details.php?id=<?php echo $row['id']; ?>' class='btn btn-info btn-sm'>Update</a>
