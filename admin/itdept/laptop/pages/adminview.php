...
$columnsResult = $conn->query("SHOW COLUMNS FROM `itlaptops`");
$columns = [];
...
<body>
    ...
    <div class="container mt-5">
        <h3 class="mt-4 mb-3 text-center text-success">IT Laptops Inventory</h3>
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <button onclick='updatelaptop(" . $row["id"] . ", \"" . implode('","', array_map(function($c) use ($row) { return $row[$c]; }, $columns)) . "\")' class='btn btn-primary'>Update</button>
                                        <br><br>
    ...
    <script>
        function updatelaptop(id, ...values) {
            $('#updateId').val(id);
