...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM itprinters WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE itprinters SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/printer/display_printer.php?pr_number=" . urlencode($pr_number) . "&dept_id=5";
            ...
            $sql_qr_update = "UPDATE itprinters SET qr_img = ? WHERE id = ?";
