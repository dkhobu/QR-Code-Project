...
$columnsResult = $conn->query("SHOW COLUMNS FROM `aetcomputers`");
$columns = [];
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <button onclick='updateComputer(" . $row["id"] . ", \"" . implode('","', array_map(function($c) use ($row) { return $row[$c]; }, $columns)) . "\")' class='btn btn-primary'>Update</button>
                                        <br><br>
        ...
        $('#updateForm').submit(function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    $('#updateErrorMessage').html(xhr.responseText).show();
                }
            });
        });
    });
