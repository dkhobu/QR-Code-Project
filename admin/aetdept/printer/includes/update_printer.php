...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM aetprinters WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE aetprinters SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/printer/display_printer.php?pr_number=" . urlencode($pr_number) . "&dept_id=1";
            ...
            $sql_qr_update = "UPDATE aetprinters SET qr_img = ? WHERE id = ?";
