...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $qrCodeImagePath = $qrCodeDir . $pr_number . '.png';

    // Generate the URL
    $url = "http://yingathungkikon.000.pe/user/printer/display_printer.php?pr_number=" . urlencode($pr_number) . "&dept_id=" . urlencode($dept_id);
    ...
    $insert_sql = "INSERT INTO aetprinters ($columns, qr_img) VALUES ($placeholders, ?)";
