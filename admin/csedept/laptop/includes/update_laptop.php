...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM cselaptops WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE cselaptops SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/laptop/display_laptop.php?lap_number=" . urlencode($lap_number) . "&dept_id=3";
            ...
            $sql_qr_update = "UPDATE cselaptops SET qr_img = ? WHERE id = ?";
