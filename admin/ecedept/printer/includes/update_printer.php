...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM eceprinters WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE eceprinters SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/printer/display_printer.php?pr_number=" . urlencode($pr_number) . "&dept_id=4";
            ...
            $sql_qr_update = "UPDATE eceprinters SET qr_img = ? WHERE id = ?";
