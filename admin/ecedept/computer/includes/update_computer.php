...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM ececomputers WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE ececomputers SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/computer/display_computer.php?pc_number=" . urlencode($pc_number) . "&dept_id=4";
            ...
            $sql_qr_update = "UPDATE ececomputers SET qr_img = ? WHERE id = ?";
