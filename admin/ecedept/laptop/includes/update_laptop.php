...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM ecelaptops WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE ecelaptops SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/laptop/display_laptop.php?lap_number=" . urlencode($lap_number) . "&dept_id=4";
            ...
            $sql_qr_update = "UPDATE ecelaptops SET qr_img = ? WHERE id = ?";
