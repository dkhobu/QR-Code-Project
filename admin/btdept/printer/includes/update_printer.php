...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_fetch = "SELECT * FROM btprinters WHERE id = ?";
    ...
    if ($row) {
        ...
        $sql_update = "UPDATE btprinters SET " . implode(', ', $updates) . " WHERE id = ?";
        ...
        if ($stmt_update->execute()) {
            ...
            $url = "http://yingathungkikon.000.pe/user/printer/display_printer.php?pr_number=" . urlencode($pr_number) . "&dept_id=2";
            ...
            $sql_qr_update = "UPDATE btprinters SET qr_img = ? WHERE id = ?";
