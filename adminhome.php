...
<body>
    <main>
        <section id="welcome" class="py-5 text-center text-white bg-primary">
            <div class="container">
                <h1 class="line-by-line center">WELCOME TO NU-SET INVENTORY SYSTEM</h1>
        ...
        <section id="Departments" class="py-5 bg-light">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card">
                            <img src="image/cseimg1.png" class="card-img-top" style="height:250px" alt="CSE Image">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card">
                            <img src="image/eceimg.jpg" class="card-img-top" alt="ECE Image">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card">
                            <img src="image/itimg.jpg" class="card-img-top" alt="IT Image">
                            <div class="card-body">
